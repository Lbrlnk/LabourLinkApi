...
//    //        _services = services;
//    //        Subscribe<ProfileCompletedEvent>("auth-profile-completed", HandleEvent);
//    //        Console.WriteLine("event is listening====================================");
//    //    }
...
//        public ProfileCompletionConsumer(RabbitMQConnection connection, IServiceProvider services)
//            : base(connection)
//        {
//            _services = services;
//            Subscribe<ProfileCompletedEvent>("auth-profile-completed", HandleEvent);
...
//        private async Task HandleEvent(ProfileCompletedEvent @event)
//        {
//            using var scope = _services.CreateScope();
//            var authRepo = scope.ServiceProvider.GetRequiredService<IAuthRepository>();
//            await authRepo.MarkProfileAsCompleted(@event.UserId);
